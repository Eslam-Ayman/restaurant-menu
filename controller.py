...
# load client_id  from google_credentials.json file
CLIENT_ID = json.loads(
    open('google_data.json', 'r').read())['web']['client_id']

# intialize global scope variable with the name of the app
...
# create database session so you can do CRUD functionality
DBSession = sessionmaker(bind=engine)
session = DBSession()

# start to authorization with Google
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('google_data.json', scope='')
...
def editRestaurant(restaurant_id):
    ...
    if editedRestaurant.user_id != login_session['user_id']:
        ...
        flash(
            '''You are not authorized to edit ""%s"" restaurant.
...
def deleteRestaurant(restaurant_id):
    ...
    if restaurantToDelete.user_id != login_session['user_id']:
        # return "<script>function myFunction() {alert(' this restaurant.
        # Please create your own restaurant in order to delete.');}
        # </script><body onload='myFunction()'>"
        flash(
            '''You are not authorized to delete ""%s"" restaurant.
            Please create your own restaurant in order to delete.'''
...
# checking if this file running from the terminal or importing it
